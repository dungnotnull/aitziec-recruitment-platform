...
export function AuditExplorer({ filters, onFiltersChange }: {
  ...
  return (
    <section className="space-y-6" aria-labelledby="audit-title">
      <header className="border-b border-border pb-5"><p className="font-mono text-xs font-semibold uppercase tracking-widest text-action">Immutable evidence</p><h1 id="audit-title" className="mt-1 font-display text-3xl font-bold text-ink">Audit log</h1><p className="mt-2 text-ink-muted">Trace who changed a recruitment resource and when.</p></header>
